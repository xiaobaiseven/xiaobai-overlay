...
SRC_URI="amd64? ( ${HOMEPAGE}/releases/download/v${PV}/lx-music-desktop.v${PV}.x64.deb -> ${MY_PN}-${PV}-x64.deb )
		x86? ( ${HOMEPAGE}/releases/download/v${PV}/lx-music-desktop.v${PV}.i386.deb -> ${MY_PN}-${PV}-i386.deb )
		arm64? ( ${HOMEPAGE}/releases/download/v${PV}/lx-music-desktop.v${PV}.arm64.deb -> ${MY_PN}-${PV}-arm63.deb )
"
LICENSE="Apache-2.0"
SLOT="0"
